...
let sum = (Number(system.jupiter.satellites) + Number(system.saturn.satellites) + Number(system.uranus.satellites) + Number(system.neptune.satellites))
console.log(sum)
...
system.jupiter.momentum = Number(system.jupiter.velocity) * Number(system.jupiter.mass)
system.pluto.momentum = Number(system.pluto.velocity) * Number(system.pluto.mass)
difference = system.jupiter.momentum - system.pluto.momentum
